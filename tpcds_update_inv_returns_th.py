# tpcds_update_inv_returns_th.py
import threading
import duckdb
import time
import random
...
def query_from_thread(con,num_loops,num_queries):
    ...
    for idx in range(num_loops):
        ...
        inv_quantity_on_hand + sr_return_quantity \
        from store_returns \
        where inv_item_sk = sr_item_sk \
